...
describe("cassandra", function()
  ...
  local types = {
    ...
    {name='float', insert_value={type='float', value=3.14151}, read_test=function(value) return math.abs(value - 3.14151) < 0.0000001 end},
    {name='float', insert_value={type='float', value=0}, read_test=function(value) return math.abs(value - 0) < 0.0000001 end},
    {name='float', insert_value=-3.14151, read_test=function(value) return math.abs(value + 3.14151) < 0.0000001 end},
    {name='float', insert_value={type='float', value=314151}, read_test=function(value) return math.abs(value - 314151) < 0.0000001 end},
